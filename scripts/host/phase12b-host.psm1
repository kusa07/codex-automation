...
function Read-Phase12BHostConfig {
    ...
    if(((& $yq.Source --version 2>$null|Out-String).Trim()) -notmatch 'version 4\.') { throw 'yq v4 is required.' }
